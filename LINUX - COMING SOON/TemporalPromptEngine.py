...
THEMES = [
    ...
    "Political - Realistic settings with formal compositions reflecting societal structures",
    "Romance - Soft focus and warm lighting to enhance emotional connections",
    ...
    "Thriller - Tense atmospheres with sharp editing and close-ups to build suspense",
    ...
    "Avant-Garde - Experimental techniques pushing the boundaries of traditional cinema",
    ...
    "French New Wave - Innovative editing and handheld camerawork breaking conventions",
    ...
    "Psychological - Visuals that explore the inner psyche using tight framing and disorientation",
    ...
    "Anime - Distinctive Japanese animation style with expressive characters and detailed backgrounds",
    "Animation - Diverse styles including 2D, 3D, and stop-motion with imaginative visuals",
    "Silent Film - Emphasis on visual storytelling through expressive acting and intertitles",
    ...
    "War - Gritty and realistic battle scenes with desaturated colors",
    "Coming of Age - Relatable visuals focusing on personal growth and self-discovery",
    "Sports - Energetic visuals capturing motion and the intensity of competition",
    "Road Movie - Visual storytelling through changing landscapes and journey motifs",
    ...
    "Slasher - Tension built through suspenseful framing and shock visuals",
    "Zombie - Post-apocalyptic settings with decayed environments and makeup effects",
    "Vampire - Gothic and nocturnal visuals emphasizing shadows and allure",
    "Film School - Emphasis on innovative techniques and exploration of cinematic language",
    ...
    "Cult Classic - Unique and unconventional visuals that garner dedicated followings",
    "Retro - Nostalgic visuals emulating styles from past decades",
    "Period Piece - Detailed historical visuals with emphasis on authenticity",
    "Noir - Moody lighting and urban nightscapes with an emphasis on shadows",
    "Psychodrama - Intimate visuals that delve into characters' mental states",
    ...
    "New Hollywood - Innovative visuals breaking away from traditional Hollywood styles",
    ...
    "B-Movie - Low-budget visuals often featuring sensational or exploitative content",
    "Grindhouse - Rough visuals with a retro feel, often emulating aged film stock",
    ...
    "Body Horror - Graphic visuals focusing on bodily transformation and mutilation",
    "Eco Thriller - Natural environments used to build tension around ecological themes",
    "Detective - Dark urban visuals with an emphasis on clues and investigative elements",
    "Gangster - Stylish visuals depicting power dynamics within organized crime",
    ...
    "Supernatural - Visuals featuring unexplained phenomena and ethereal effects",
    "Folklore - Traditional visuals rooted in cultural myths and legends",
    "Period Drama - Detailed historical settings with an emphasis on costumes and decor",
    ...
    "Environmental - Natural landscapes used to highlight ecological themes",
    "Travelogue - Scenic visuals showcasing diverse locations and cultures",
    ...
    "Mythology - Epic visuals depicting gods, heroes, and legendary tales",
    ...
    "Road Horror - Isolated settings and desolate roads enhancing suspense",
    "Home Invasion - Tension built through familiar settings turned threatening",
    "Sci-Fi Horror - Futuristic visuals combined with unsettling atmospheres",
    "Space Horror - Claustrophobic spacecraft visuals amplifying fear",
    "Comedy Horror - Juxtaposition of frightening and humorous visuals",
    "Postmodern Comedy - Self-referential visuals breaking the fourth wall",
    "Arthouse Horror - Artistic visuals creating a unique and unsettling experience",
    "Historical Epic - Grandiose visuals with large-scale sets and crowd scenes",
    "Time Loop - Repetitive visuals emphasizing the cyclical nature of time",
    "Body Swap - Visual contrasts highlighting character changes",
    ...
    "Whimsical - Playful and imaginative visuals with a light-hearted tone",
    "Folklore Horror - Rural visuals tapping into traditional fears and myths",
    "Religious - Symbolic visuals exploring spiritual themes",
    "Propaganda - Persuasive visuals designed to influence opinions",
    "Avant-garde - Innovative and abstract visuals challenging conventional cinema",
    "Gothic Horror - Ornate and atmospheric visuals with a haunting quality",
    "Magical Realism Drama - Subtle fantastical visuals within realistic settings",
    "Romantic Fantasy - Enchanting visuals blending love and magic",
    ...
    "Space Western - Fusion of space visuals with Western genre elements",
    ...
    "Samurai Western - Blend of Eastern and Western visuals and themes",
    "Gothic Romance - Dark and moody visuals with an emphasis on emotion",
    "Psychological Thriller - Unsettling visuals creating tension and ambiguity",
    "Psychodrama - Visuals focusing on internal conflicts and mental states",
    "Film Essay - Visually driven explorations of concepts and ideas",
    "Documentary Drama - Realistic visuals with narrative elements",
    "Docu-Fiction - Blending documentary style with fictional storytelling",
    "Road Comedy - Changing settings providing a backdrop for humor",
    "Horror Anthology - Varied visuals presenting multiple horror stories",
    "Science Fiction Anthology - Diverse futuristic visuals across different tales",
    "Fantasy Anthology - Collection of stories with varied fantastical visuals",
    "Musical Anthology - Different musical styles showcased visually",
    "Animated Anthology - Variety of animation styles presented together",
    "Mockumentary Comedy - Satirical visuals mimicking documentary filmmaking",
    "Satire Comedy - Visual exaggeration to critique and entertain",
    ...
    "Space Documentary - Visual exploration of the universe",
    ...
    "Dark Drama - Somber visuals reflecting serious themes",
    "Romantic Drama - Visually rich settings enhancing emotional connections",
    "Adventure Drama - Visually compelling journeys with character depth",
    ...
    "Musical Drama - Emotional depth conveyed through music and visuals",
    "Science Fiction Drama - Futuristic visuals with a focus on character-driven stories",
    "Fantasy Drama - Magical visuals intertwined with dramatic narratives",
    ...
    "Medical Thriller - High-stakes visuals within medical environments",
    ...
    "Techno Thriller - Modern visuals highlighting technological dangers",
    "Psychological Thriller - Visual manipulation to unsettle and intrigue",
    "Spy Thriller - Stylish and international visuals emphasizing secrecy",
    "Disaster Thriller - Dramatic visuals depicting catastrophic events",
    "Survival Thriller - Isolated visuals focusing on endurance",
    "Erotic Thriller - Sensual visuals intertwined with suspense",
    ...
    "Fantasy Thriller - Magical visuals with elements of suspense",
    "Western Thriller - Frontier visuals with heightened tension",
    ...
    "Psychological Horror - Visuals that disturb and provoke psychological fear",
    "Supernatural Horror - Uncanny visuals involving otherworldly entities",
    "Slasher Horror - Visceral visuals emphasizing suspense and shock",
    "Gore Horror - Graphic and explicit visuals meant to unsettle",
    "Monster Horror - Creature designs that evoke fear and fascination",
    "Paranormal Horror - Subtle visuals suggesting unseen forces",
    "Found Footage Horror - Authentic visuals creating immediacy and realism",
    "Folk Horror - Rural visuals tapping into ancient traditions and fears",
    "Body Horror - Distorted visuals exploring physical transformation",
    "Zombie Horror - Apocalyptic visuals with hordes of undead",
    "Vampire Horror - Dark and seductive visuals with nocturnal settings",
    "Ghost Horror - Ethereal visuals creating a haunting atmosphere",
    "Sci-Fi Horror - Futuristic visuals combined with horror elements",
    "Occult Horror - Ritualistic visuals with esoteric symbols",
    "Cosmic Horror - Vast and incomprehensible visuals inducing existential dread",
    "Comedy Horror - Contrasting visuals blending horror and humor",
    "Dark Fantasy Horror - Fantastical visuals with dark and ominous tones",
    "Survival Horror - Tense visuals emphasizing vulnerability",
    "Urban Horror - City settings turned sinister through visual manipulation",
    "Rural Horror - Isolated visuals amplifying fear of the unknown",
    "Gothic Horror - Ornate and decaying visuals creating a haunting mood",
    "Haunted House Horror - Confined spaces with unsettling visuals",
    "Alien Horror - Unfamiliar and disturbing extraterrestrial visuals",
    "Religious Horror - Symbolic visuals exploring themes of faith and fear",
    "Mythological Horror - Ancient visuals invoking legendary terrors",
    "Psychological Horror - Visuals that challenge perception and reality"
]
